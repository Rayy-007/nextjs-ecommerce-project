...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <Link href={`/products/${product.id}`} className="card shadow-md">
      <figure className="relative">
        <span className="btn-error btn-sm btn absolute left-4 top-4 text-white ">
          - 40%
        </span>
        <span className="badge badge-neutral absolute right-4 top-4">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <span className="badge badge-neutral absolute right-4 top-11">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
